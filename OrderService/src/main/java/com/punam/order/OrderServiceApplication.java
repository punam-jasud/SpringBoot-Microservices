...
import com.punam.order.external.interceptor.RestTemplateInterceptor;
...
public class OrderServiceApplication {
	...
	@Bean
	OAuth2AuthorizedClientManager clientManager(ClientRegistrationRepository clientRegistrationRepository,
